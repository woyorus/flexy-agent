/**
 * Scenario 060 — show_plan day detail via natural-language day reference.
 *
 * Plan 030 (Plan E). User types "what's Thursday looking like?" on a
 * Tuesday. The dispatcher resolves "Thursday" to 2026-04-09 (the next
 * Thursday within the plan horizon), picks `show_plan({ screen: 'day_detail',
 * day: '2026-04-09' })`, and the handler calls `renderDayDetail` for that
 * day.
 *
 * Seed: active plan Apr 6–12 with the standard four-batch layout.
 * Thursday Apr 9 is the start of the second cook cycle (bolognese lunch +
 * pork rice bowls dinner).
 *
 * Sequence:
 *   1. Type "what's Thursday looking like?" — dispatcher resolves to ISO
 *      date 2026-04-09, picks show_plan day_detail, handler renders.
 *
 * Clock: 2026-04-07T10:00:00Z (Tuesday morning — Thursday = 2026-04-09).
 */
...
const activeSession: PlanSession = {
  id: 'sess-060-0000-0000-0000-000000000001',
...
const activeBatches: Batch[] = [
  ...
  {
    id: 'batch-060-lunch1-0000-0000-000000000001',
  ...
  {
    id: 'batch-060-dinner1-0000-0000-000000000002',
  ...
  // Batch 3: Thu–Sat Lunch (bolognese) — visible on Thursday
  {
    id: 'batch-060-lunch2-0000-0000-000000000003',
  ...
  // Batch 4: Thu–Fri Dinner (pork rice bowls) — visible on Thursday
  {
    id: 'batch-060-dinner2-0000-0000-000000000004',
...
export default defineScenario({
  name: '060-show-plan-day-detail-natural-language',
  description:
    'User types "what\'s Thursday looking like?". Dispatcher resolves to ISO date 2026-04-09, ' +
    'picks show_plan day_detail, handler renders the day detail view. Plan 030.',
  ...
  events: [
    text("what's Thursday looking like?"),
  ],
});
