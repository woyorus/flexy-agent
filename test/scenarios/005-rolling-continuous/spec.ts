...
const batchesA: Batch[] = [
  ...
  },
  {
    ...
    scaledIngredients: [{ name: 'pork tenderloin', amount: 180, unit: 'g', totalForBatch: 540, role: 'protein' as const }],
    status: 'planned',
    createdInPlanSessionId: sessionA.id,
  },
  {
    ...
    scaledIngredients: [{ name: 'tuna', amount: 150, unit: 'g', totalForBatch: 150, role: 'protein' as const }],
    status: 'planned',
    createdInPlanSessionId: sessionA.id,
  },
  {
    ...
    scaledIngredients: [{ name: 'salmon fillet', amount: 160, unit: 'g', totalForBatch: 320, role: 'protein' as const }],
    status: 'planned',
    createdInPlanSessionId: sessionA.id,
  },
  {
    ...
    scaledIngredients: [{ name: 'ground beef', amount: 200, unit: 'g', totalForBatch: 400, role: 'protein' as const }],
    status: 'planned',
    createdInPlanSessionId: sessionA.id,
  },
  {
    ...
    scaledIngredients: [{ name: 'beef stew meat', amount: 180, unit: 'g', totalForBatch: 540, role: 'protein' as const }],
    status: 'planned',
    createdInPlanSessionId: sessionA.id,
  },
];
