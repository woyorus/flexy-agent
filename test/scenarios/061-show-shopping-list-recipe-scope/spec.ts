/**
 * Scenario 061 — show_shopping_list with recipe scope.
 *
 * Plan 030 (Plan E). User types "shopping list for the tagine". The
 * dispatcher picks `show_shopping_list({ scope: 'recipe',
 * recipe_slug: 'moroccan-beef-tagine-style-skillet-with-lemon-couscous' })`,
 * the handler calls `generateShoppingListForRecipe` and renders the
 * scoped list showing only the tagine's ingredients.
 *
 * Seed: active plan Apr 6–12 with the standard four-batch layout.
 * The tagine is batch 2 (Mon–Wed dinner).
 *
 * Sequence:
 *   1. Type "shopping list for the tagine" — dispatcher picks
 *      show_shopping_list with recipe scope, handler renders.
 *
...
const activeSession: PlanSession = {
  id: 'sess-061-0000-0000-0000-000000000001',
...
const activeBatches: Batch[] = [
  ...
  {
    id: 'batch-061-lunch1-0000-0000-000000000001',
  ...
  // Batch 2: Mon–Wed Dinner (tagine) — the batch the user asks about
  {
    id: 'batch-061-dinner1-0000-0000-000000000002',
  ...
  {
    id: 'batch-061-lunch2-0000-0000-000000000003',
  ...
  {
    id: 'batch-061-dinner2-0000-0000-000000000004',
...
export default defineScenario({
  name: '061-show-shopping-list-recipe-scope',
  description:
    'User types "shopping list for the tagine". Dispatcher picks show_shopping_list with recipe scope, ' +
    'handler renders the tagine-only ingredient list. Plan 030.',
  ...
  events: [
    text('shopping list for the tagine'),
  ],
});
