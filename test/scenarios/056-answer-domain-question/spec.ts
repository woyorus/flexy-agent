/**
 * Scenario 056 — answer_domain_question via dispatcher.
 *
 * Plan 030 (Plan E). User types "What's a good substitute for tahini?"
 * with no particular surface context. The dispatcher picks
 * `answer_domain_question` and replies inline with a short generic answer
 * from model knowledge. Locks v0.0.5 behavior — generic model knowledge,
 * no opinionated knowledge base yet.
 *
 * Seed: active plan Apr 6–12 (the plan exists so the user is in the
 * active_mid lifecycle, but the question is domain-general, not
 * plan-specific).
 *
 * Sequence:
 *   1. Type "What's a good substitute for tahini?" — dispatcher picks
 *      answer_domain_question, responds inline.
 *
 * Clock: 2026-04-07T15:00:00Z (Tuesday afternoon).
 */
...
const activeSession: PlanSession = {
  id: 'sess-056-0000-0000-0000-000000000001',
...
const activeBatches: Batch[] = [
  ...
  {
    id: 'batch-056-lunch1-0000-0000-000000000001',
  ...
  {
    id: 'batch-056-dinner1-0000-0000-000000000002',
  ...
  {
    id: 'batch-056-lunch2-0000-0000-000000000003',
  ...
  {
    id: 'batch-056-dinner2-0000-0000-000000000004',
...
export default defineScenario({
  name: '056-answer-domain-question',
  description:
    'User types "What\'s a good substitute for tahini?". Dispatcher picks answer_domain_question, ' +
    'replies inline with generic model knowledge. Plan 030.',
  clock: '2026-04-07T15:00:00Z',
  ...
  events: [
    text("What's a good substitute for tahini?"),
  ],
});
