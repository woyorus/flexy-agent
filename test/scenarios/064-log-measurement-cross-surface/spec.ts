/**
 * Scenario 064 — log_measurement from the plan surface (cross-surface).
 *
 * Plan 030 (Plan E). User is on the plan surface (taps "My Plan" first)
 * and types "82.3 today". The dispatcher picks `log_measurement` with
 * `weight: 82.3`, the handler delegates to the existing measurement
 * parsing + store pipeline. The measurement lands in the store, the user
 * gets a confirmation, and `surfaceContext` stays 'plan' — the user does
 * NOT get teleported to the progress surface.
 *
 * This locks the cross-surface measurement logging behavior: JTBD D2
 * ("log a measurement under 5 seconds") works from any surface.
 *
 * Seed: active plan Apr 6–12. No measurement logged today so the
 * log succeeds without "already logged" interference.
 *
 * Sequence:
 *   1. Tap "My Plan" (reply keyboard) — establishes plan surface context.
 *   2. Type "82.3 today" — dispatcher picks log_measurement, handler
 *      logs the measurement, confirms.
 *
...
const activeSession: PlanSession = {
  id: 'sess-064-0000-0000-0000-000000000001',
...
const activeBatches: Batch[] = [
  ...
  {
    id: 'batch-064-lunch1-0000-0000-000000000001',
  ...
  {
    id: 'batch-064-dinner1-0000-0000-000000000002',
  ...
  {
    id: 'batch-064-lunch2-0000-0000-000000000003',
  ...
  {
    id: 'batch-064-dinner2-0000-0000-000000000004',
...
export default defineScenario({
  name: '064-log-measurement-cross-surface',
  description:
    'User on plan surface types "82.3 today". Dispatcher picks log_measurement, measurement logged, ' +
    'surfaceContext stays plan. Cross-surface measurement logging regression lock. Plan 030.',
