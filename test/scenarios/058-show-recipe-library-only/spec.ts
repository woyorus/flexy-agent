/**
 * Scenario 058 — show_recipe for a recipe NOT in any active batch (library fallback).
 *
 * Plan 030 (Plan E). User types "show me the salmon linguine" and that
 * recipe (creamy-salmon-and-shrimp-linguine) is in the recipe DB but NOT
 * in any active batch. The dispatcher picks `show_recipe`, the handler
 * finds no matching batch, and falls back to the library view with
 * per-serving amounts.
 *
 * Seed: active plan Apr 6–12 with the standard four-batch layout. The
 * linguine recipe is in the six-balanced recipe set but not in any batch.
 *
 * Sequence:
 *   1. Type "show me the salmon linguine" — dispatcher picks show_recipe,
 *      handler finds no matching batch, renders the library recipe view.
 *
...
const activeSession: PlanSession = {
  id: 'sess-058-0000-0000-0000-000000000001',
...
const activeBatches: Batch[] = [
  ...
  {
    id: 'batch-058-lunch1-0000-0000-000000000001',
  ...
  {
    id: 'batch-058-dinner1-0000-0000-000000000002',
  ...
  {
    id: 'batch-058-lunch2-0000-0000-000000000003',
  ...
  {
    id: 'batch-058-dinner2-0000-0000-000000000004',
...
export default defineScenario({
  name: '058-show-recipe-library-only',
  description:
    'User types "show me the salmon linguine" — recipe is in the library but NOT in any active batch. ' +
    'Dispatcher picks show_recipe, handler falls back to library view with per-serving amounts. Plan 030.',
  ...
  events: [
    text('show me the salmon linguine'),
  ],
});
