...
per_serving:
  ...
  carbs: 60
ingredients:
  - name: beef braising steak, trimmed
    amount: 225
    unit: g
    role: protein
    component: Moroccan beef tagine-style skillet
  - name: olive oil
    amount: 25
    unit: g
    role: fat
...
storage:
  fridge_days: 3
  freezable: true
  reheat: Store the beef tagine-style skillet and couscous separately in airtight
    containers. Reheat the beef gently in a covered pan or in the microwave
    until piping hot, adding a splash of water if the sauce thickens. Reheat the
    couscous briefly with a teaspoon of water, then fluff with a fork.
---
...
Storage: Cool quickly, then store the beef and couscous separately in airtight containers in the fridge for up to 3 days. It freezes well, but the couscous is best cooked fresh if you want the best texture.

Reheating: Reheat the beef gently on the hob or in the microwave until piping hot, adding a splash of water if needed. Reheat the couscous briefly and fluff it again before serving.

Tip: For an even more classic Moroccan finish, add a few sliced green olives or a little preserved lemon at the end.
